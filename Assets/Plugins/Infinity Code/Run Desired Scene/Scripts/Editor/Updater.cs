...
namespace InfinityCode.RunDesiredScene
{
    ...
    {
        private const string packageID = "Run Desired Scene";
        private const string lastVersionKey = EditorUtils.PREFS_PREFIX + "LastVersion";
        private const string lastVersionCheckKey = EditorUtils.PREFS_PREFIX + "LastVersionCheck";
        private const string channelKey = EditorUtils.PREFS_PREFIX + "UpdateChannel";
        private const string invoiceNumberKey = EditorUtils.PREFS_PREFIX + "InvoiceNumber";
        ...
        public static void CheckNewVersionAvailable()
        {
            ...
            client.UploadDataCompleted += delegate (object sender, UploadDataCompletedEventArgs response)
            {
                ...
                {
                    Debug.Log("Automatic check for Run Desired Scene updates: Bad response.");
                    return;
                }
        ...
        [MenuItem(EditorUtils.MENU_PATH + "Check Updates", false, 123)]
        public static void OpenWindow()
        {
            GetWindow<Updater>(false, "Run Desired Scene Updater", true);
        }
