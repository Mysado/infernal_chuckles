...
namespace Sisus.Init
{
    ...
    public static class ICoroutinesExtensions
    {
        ...
        /// </para>
        /// </returns>
        public static Coroutine StartCoroutine<T>([DisallowNull] this T @this, [DisallowNull] IEnumerator coroutine) where T : ICoroutines
        {
            if(@this.CoroutineRunner != null)
            {
                return @this.CoroutineRunner.StartCoroutine(coroutine);
            }
            ...
            return Updater.StartCoroutine(coroutine);
        }
        ...
        public static void StopCoroutine<TObject>([DisallowNull]this TObject @this, [DisallowNull] IEnumerator coroutine) where TObject : ICoroutines
        {
            if(@this.CoroutineRunner != null)
            {
