...
namespace Sisus.Init
{
    ...
    /// <see cref="GameObjectExtensions.AddComponent{TWrapped, TWrapped}"/> function.
    /// </para>
    /// <para>
    ...
    public abstract class Wrapper<TWrapped> : MonoBehaviour, IWrapper<TWrapped>, IValueProvider<TWrapped>, ICoroutineRunner, IValueByTypeProvider
    {
        /// <summary>
        ...
        /// the component is created using <see cref="ObjectExtensions.Instantiate{TWrapped}"/> or
        /// <see cref="GameObjectExtensions.AddComponent{TWrapper, TWrapped}">GameObject.AddComponent{TComponent, TArgument}</see>.
        /// </para>
        /// <para>
        ...
        private void Init(TWrapped wrapped)
        {
            ...
            if(wrapped is ICoroutines coroutineUser)
            {
