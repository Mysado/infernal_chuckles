...
namespace Sisus.Init
{
	...
	public static class InitArgs<TFirstArgument, TSecondArgument, TThirdArgument>
	{
		...
		public static bool TryGet<TClient>(Context context, [DisallowNull] TClient client) where TClient : IInitializable<TFirstArgument, TSecondArgument, TThirdArgument>
		{
