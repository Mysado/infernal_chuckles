...
namespace Sisus.Init
{
	...
	/// <see cref="ObjectExtensions.Instantiate{TComponent, TFirstArgument, TSecondArgument}">instantiated</see>
	...
	public abstract class MonoBehaviour<TFirstArgument, TSecondArgument> : MonoBehaviour, IInitializable<TFirstArgument, TSecondArgument>, IInitializable
	{
		...
		/// the component is created using <see cref="ObjectExtensions.Instantiate{TFirstArgument, TSecondArgument}"/> or
		/// <see cref="GameObjectExtensions.AddComponent{TComponent, TFirstArgument, TSecondArgument}">GameObject.AddComponent{TComponent, TFirstArgument, TSecondArgument}</see>.
		/// </para>
		/// <para>
		...
		private bool Init(Context context)
		{
			...
			#if DEBUG
			initializing = true;
			if(context != Context.EditMode) { ValidateArguments(firstArgument, secondArgument); }
			#endif
