...
namespace Sisus.Init
{
	...
	/// <see cref="ObjectExtensions.Instantiate{TComponent, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument}">instantiated</see>
	...
	/// to a <see cref="GameObject"/> with five arguments passed to the <see cref="Init"/> function of the created instance.
	/// <para>
	...
	public abstract class MonoBehaviour<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument> : MonoBehaviour, IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>, IInitializable
	{
		#if DEBUG
		/// <summary>
		...
		/// the component is created using <see cref="ObjectExtensions.Instantiate{TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument}"/> or
		/// <see cref="GameObjectExtensions.AddComponent{TComponent, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument}">GameObject.AddComponent{TComponent, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument}</see>.
		/// </para>
		/// <para>
		...
		private bool Init(Context context)
		{
			...
			#if DEBUG
			initializing = true;
			if(context != Context.EditMode) { ValidateArguments(firstArgument, secondArgument, thirdArgument, fourthArgument, fifthArgument); }
			#endif
