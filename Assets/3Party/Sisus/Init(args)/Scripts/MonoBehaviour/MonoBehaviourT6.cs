...
namespace Sisus.Init
{
	...
	/// <see cref="ObjectExtensions.Instantiate{TComponent, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument}">instantiated</see>
	...
	/// to a <see cref="GameObject"/> with six arguments passed to the <see cref="Init"/> function of the created instance.
	/// <para>
	...
	public abstract class MonoBehaviour<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument> : MonoBehaviour, IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>, IInitializable
	{
		...
		/// the component is created using <see cref="ObjectExtensions.Instantiate{TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument}"/> or
		/// <see cref="GameObjectExtensions.AddComponent{TComponent, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument}">GameObject.AddComponent{TComponent, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument}</see>.
		/// </para>
		/// <para>
		...
		private bool Init(Context context)
		{
			...
			#if DEBUG
			initializing = true;
			if(context != Context.EditMode) { ValidateArguments(firstArgument, secondArgument, thirdArgument, fourthArgument, fifthArgument, sixthArgument); }
			#endif
		...
		{
			#if DEBUG
			if(argument == Null) throw new ArgumentNullException(null, $"Sixth {nameof(Init)} argument of type {typeof(TSixthArgument).Name} passed to {GetType().Name} was null.");
			#endif
		}
		...
		{
			#if DEBUG
			if(argument == Null) Debug.LogAssertion($"Sixth {nameof(Init)} argument of type {typeof(TSixthArgument).Name} passed to {GetType().Name} was null.", this);
			#endif
		}
	}
}