...
namespace Sisus.Init.ValueProviders
{
		...
		#endif
	{
		...
		public async ValueTask<object> GetForAsync2(Component client) => await GetForAsync(client);
		...
		/// </returns>
		public async ValueTask<Sprite> GetForAsync([AllowNull] Component client)
		{
			#if UNITY_EDITOR
