...
namespace Sisus.Init
{
	...
	public interface IValueByTypeProviderAsync
	{
		...
		/// </param>
		/// <returns>
		/// <see cref="ValueTask{TValue}"/> that can be awaited to get the value of type <typeparamref name="TValue"/>, if available;
		/// otherwise, <see cref="ValueTask{TValue}.FromResult(default)"/>.
		/// </returns>
		ValueTask<TValue> GetForAsync<TValue>([AllowNull] Component client);
