...
namespace Sisus.Init
{
	...
	/// <see cref="ObjectExtensions.Instantiate{TComponent, TFirstArgument, TSecondArgument, TThirdArgument}">instantiated</see>
	...
	public abstract class MonoBehaviour<TFirstArgument, TSecondArgument, TThirdArgument> : MonoBehaviour, IInitializable<TFirstArgument, TSecondArgument, TThirdArgument>, IInitializable
	{
		#if DEBUG
		/// <summary>
		...
		/// the component is created using <see cref="ObjectExtensions.Instantiate{TFirstArgument, TSecondArgument, TThirdArgument}"/> or
		/// <see cref="GameObjectExtensions.AddComponent{TComponent, TFirstArgument, TSecondArgument, TThirdArgument}">GameObject.AddComponent{TComponent, TFirstArgument, TSecondArgument, TThirdArgument}</see>.
		/// </para>
		/// <para>
		...
		private bool Init(Context context)
		{
			...
			#if DEBUG
			initializing = true;
			if(context != Context.EditMode) { ValidateArguments(firstArgument, secondArgument, thirdArgument); }
			#endif
