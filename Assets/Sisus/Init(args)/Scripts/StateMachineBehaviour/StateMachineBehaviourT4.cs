...
namespace Sisus.Init
{
	...
	/// can receive four objects they depend on during their initialization.
	/// <para>
	/// Arguments can be specified using a <see cref="StateMachineBehaviourInitializer{TStateMachineBehaviour, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument}"/>.
	...
	public abstract class StateMachineBehaviour<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument> : StateMachineBehaviour,
		IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>
	{
		...
		protected object this[[DisallowNull] string memberName]
        {
			set
			{
				...
				Inject<StateMachineBehaviour<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>(this, memberName, value);
			}
        }
