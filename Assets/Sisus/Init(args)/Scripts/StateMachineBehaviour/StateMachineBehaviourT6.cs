...
namespace Sisus.Init
{
	...
	/// can receive six objects they depend on during their initialization.
	/// <para>
	/// Arguments can be specified using a <see cref="StateMachineBehaviourInitializer{TStateMachineBehaviour, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument}"/>.
	...
	public abstract class StateMachineBehaviour<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument> : StateMachineBehaviour,
		IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>
	{
		...
		protected object this[[DisallowNull] string memberName]
        {
			set
			{
				...
				Inject<StateMachineBehaviour<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>(this, memberName, value);
			}
        }
