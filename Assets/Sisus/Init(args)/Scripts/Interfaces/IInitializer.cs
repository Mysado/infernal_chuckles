...
namespace Sisus.Init
{
	...
	public interface IInitializer
	{
		...
		/// <summary>
		/// Returns an awaitable task for initializing the client object with the arguments specified by this initializer.
		/// <para>
		...
		/// </summary>
		/// <returns> The initialized object. </returns>
		ValueTask<object> InitTargetAsync();
	}
	...
	public interface IInitializer<TClient> : IInitializer
	{
		...
		/// </summary>
		/// <returns> The initialized object. </returns>
		new ValueTask<TClient> InitTargetAsync();
	}
