...
namespace Sisus.Init.Reflection
{
	...
	public static class ObjectExtensions
	{
		...
		/// or if a field or property was found but a <paramref name="value"/> of type <typeparamref name="TValue"/> is not assignable to it.
		/// </exception>
		private static void SetPropertyOrFieldValue<TClient>(TClient client, [DisallowNull] string name, object value)
        {
		...
		/// or if a field or property was found but a <paramref name="value"/> of type <typeparamref name="TValue"/> is not assignable to it.
		/// </exception>
		private static void SetPropertyOrFieldValue<TClient>(TClient client, [DisallowNull] object value)
        {
