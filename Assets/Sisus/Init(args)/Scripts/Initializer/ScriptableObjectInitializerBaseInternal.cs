...
namespace Sisus.Init.Internal
{
		...
		where TClient : ScriptableObject
	{
		...
		/// <inheritdoc/>
		public async ValueTask<TClient> InitTargetAsync()
		{
			if(this == null)
			{
				return target;
		...
		[return: NotNull]
		private protected virtual ValueTask<TClient> InitTargetAsync([AllowNull] TClient target) => new ValueTask<TClient>(target);
