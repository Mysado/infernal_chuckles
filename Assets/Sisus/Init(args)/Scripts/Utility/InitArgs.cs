...
namespace Sisus.Init
{
	...
	public static class InitArgs
    {
        private readonly struct Arg<TArgument>
		{
			...
			public static bool Clear([DisallowNull] Type clientType)
			{
				if(arg.TryGetValue(clientType, out var dependency))
				{
					arg.TryRemove(clientType, out _);
		...
		{
			Arg<TArgument>.arg[typeof(TClient)] = new Arg<TArgument>(argument, received:false);
		...
		{
			Args<TFirstArgument, TSecondArgument>.args[typeof(TClient)] = new Args<TFirstArgument, TSecondArgument>(firstArgument, secondArgument, received:false);
				...
				where TClient : IArgs<TFirstArgument, TSecondArgument, TThirdArgument>
		{
			Args<TFirstArgument, TSecondArgument, TThirdArgument>.args[typeof(TClient)]
				= new Args<TFirstArgument, TSecondArgument, TThirdArgument>(firstArgument, secondArgument, thirdArgument, received:false);
				...
				where TClient : IArgs<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>
		{
			Args<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>.args[typeof(TClient)]
				= new Args<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>(firstArgument, secondArgument, thirdArgument, fourthArgument, received:false);
				...
				where TClient : IArgs<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>
		{
			Args<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>.args[typeof(TClient)]
				= new Args<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>(firstArgument, secondArgument, thirdArgument, fourthArgument, fifthArgument, received:false);
				...
				where TClient : IArgs<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>
		{
			Args<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>.args[typeof(TClient)]
				= new Args<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>(firstArgument, secondArgument, thirdArgument, fourthArgument, fifthArgument, sixthArgument, received:false);
		...
		public static bool TryGet<TClient, TArgument>(Context context, [DisallowNull] TClient client, out TArgument argument) where TClient : IArgs<TArgument>
		{
			...
			{
				#if UNITY_EDITOR
				if(context is not Context.Reset)
				{
				#endif

				argument = dependency.argument;
				args[clientType] = new Arg<TArgument>(argument, received:true);
				return true;
				...
				where TClient : IArgs<TFirstArgument, TSecondArgument>
		{
			...
			if(args.TryGetValue(clientType, out var dependencies))
			{
				...
				args[clientType] = new Args<TFirstArgument, TSecondArgument>(firstArgument, secondArgument, received:true);
				return true;
			}
				...
				where TClient : IArgs<TFirstArgument, TSecondArgument, TThirdArgument>
		{
			...
			if(args.TryGetValue(clientType, out var dependencies))
			{
				...
				args[clientType] = new Args<TFirstArgument, TSecondArgument, TThirdArgument>(firstArgument, secondArgument, thirdArgument, received:true);
				return true;
			}
				...
				where TClient : IArgs<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>
		{
			...
			if(args.TryGetValue(clientType, out var dependencies))
			{
				...
				args[clientType] = new Args<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>(firstArgument, secondArgument, thirdArgument, fourthArgument, received:true);
				return true;
			}
				...
				where TClient : IArgs<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>
		{
			...
			if(args.TryGetValue(clientType, out var dependencies))
			{
				...
				args[clientType] = new Args<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>(firstArgument, secondArgument, thirdArgument, fourthArgument, fifthArgument, received:true);
				return true;
			}
				...
				where TClient : IArgs<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>
		{
			...
			if(args.TryGetValue(clientType, out var dependencies))
			{
				...
				args[clientType] = new Args<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>(firstArgument, secondArgument, thirdArgument, fourthArgument, fifthArgument, sixthArgument, received:true);
				return true;
			}
		...
		internal static void Set<TArgument>([DisallowNull] Type clientType, TArgument argument)
		{
			...
			Arg<TArgument>.arg[clientType] = new Arg<TArgument>(argument, received:false);
			...
			([DisallowNull] Type clientType, TFirstArgument firstArgument, TSecondArgument secondArgument)
		{
			...
			Args<TFirstArgument, TSecondArgument>.args[clientType] = new Args<TFirstArgument, TSecondArgument>(firstArgument, secondArgument, received:false);
