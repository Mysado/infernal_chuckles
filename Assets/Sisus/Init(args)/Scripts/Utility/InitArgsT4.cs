...
namespace Sisus.Init
{
	...
	/// <see cref="IArgs{TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument}"/> interface such as
	/// <see cref="MonoBehaviour{TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument}"/> and
	/// <see cref="ScriptableObject{TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument}"/>.
	/// </summary>
	...
	public static class InitArgs<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>
	{
		/// <summary>
		/// Calls the <see cref="IInitializable{TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument}.Init">Init</see> function on the <paramref name="client"/>
		/// with the arguments previously stored using the <see cref="InitArgs.Set{TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument}">Set</see> function.
		/// <para>
		...
		/// </para>
		/// <para>
		/// The <paramref name="client"/> must implement the <see cref="IInitializable{TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument}"/> interface in order for it to be used with this function.
		/// </para>
		/// </summary>
		...
		public static bool TryGet<TClient>(Context context, [DisallowNull] TClient client) where TClient : IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>
		{
			if(InitArgs.TryGet(context, client, out TFirstArgument firstArgument, out TSecondArgument secondArgument, out TThirdArgument thirdArgument, out TFourthArgument fourthArgument))
            {
