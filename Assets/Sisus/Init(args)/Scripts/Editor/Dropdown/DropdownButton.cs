...
namespace Sisus.Init.EditorOnly
{
	internal class DropdownButton
    {
        ...
        public void Draw(Rect position)
        {
            ...
            bool clicked = GUI.Button(iconRect, GUIContent.none, "PopupCurveDropdown");
            ...
            if(buttonLabel.text.Length > 0)
            {
                ...
                bool tintRed = colorWas == Color.red || AnyGUI.CurrentlyDrawnItemFailedNullGuard;
                if(tintRed)
				{
                    GUI.color = Color.red;
				}

                GUI.Label(labelRect, buttonLabel, EditorStyles.boldLabel);
            }
