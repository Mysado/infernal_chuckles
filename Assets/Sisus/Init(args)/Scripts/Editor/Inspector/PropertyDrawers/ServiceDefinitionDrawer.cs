...
namespace Sisus.Init.EditorOnly
{
	...
	internal class ServiceDefinitionDrawer : PropertyDrawer
	{
		...
		private void RebuildDefiningTypeButton(SerializedProperty property, State state)
		{
			...
			//CurrentValue currentValue = definingType is null ? CurrentValue.DrodownAndLabel : CurrentValue.LabelAndDiscard;

			state.definingTypeButton = new TypeDropdownButton(GUIContent.none, definingTypeLabel, typeOptions, Enumerable.Repeat(definingType, 1), /*currentValue, */(setType) =>
			{
