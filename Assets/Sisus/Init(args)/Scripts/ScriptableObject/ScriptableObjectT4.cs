...
namespace Sisus.Init
{
		...
		#endif
	{
		...
		{
			#if DEBUG
			if(argument == Null) throw new ArgumentNullException(null, $"Fourth argument passed to {GetType().Name} was null.");
			#endif
		}
		...
		{
			#if DEBUG
			if(argument == Null) Debug.LogAssertion($"Fourth argument passed to {GetType().Name} was null.", this);
			#endif
		}
	}
}