...
namespace Sisus.Init
{
	...
	/// or <see cref="ObjectExtensions.Instantiate{TScriptableObject, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument}">instantiated</see>
	/// with five arguments passed to the <see cref="Init"/> function of the created instance.
	/// <para>
